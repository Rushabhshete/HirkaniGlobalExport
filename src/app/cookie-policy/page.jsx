export const metadata = {
  ...
  description:
    "Learn how Fourzaa Global uses cookies to improve your experience and manage global export inquiries.",
};
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <header className="mb-10">
          ...
          <p className="text-foreground/70">
            This Cookie Policy explains how Fourzaa Global uses cookies and
